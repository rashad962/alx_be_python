...
def main():
    try:
        ...
        temperature = float(temperature_input)  # Ensure the input is a valid float

        # Prompt user for unit and validate it
        ...
        # Handle the case when the user does not enter a valid numeric value
